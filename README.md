...
Pay-per-event: **$2 per 1,000 job rows**, plus a small $0.005 per-run start fee. Company-profile rows are **free**. Tiered plan discounts
...
- **[Google Hotels Scraper](https://apify.com/factden/google-hotels-scraper?fpr=factden)** — live hotel prices,
  OTA rate ladder & reviews.
...
- **[Expedia Hotel Reviews Scraper](https://apify.com/factden/expedia-hotel-reviews-scraper?fpr=factden)** —
  hotel reviews, ratings & sentiment.
...
[expedia-hotel-reviews-scraper](https://github.com/factden/expedia-hotel-reviews-scraper)
